                    ...
                    <tbody class="sortable" data-url="<?php echo base_url("galleries/rankGalleryVideoSetter"); ?>">
                        ...
                        <?php foreach ($items as $item) { ?>
                            ...
                            <tr id="ord-<?php echo $item->id; ?>">
                                ...
                                <td class="w50 text-center" style="font-size : 10px; !important">#<?php echo $item->id; ?></td>
                                <td class="w200" style="font-size : 10px; !important"><?php echo $item->url; ?></td>
                                <td class="text-center">
                                    <iframe width="120" src="<?php echo $item->url; ?>" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen>

                                    </iframe>
                                </td>
                                <td class="text-center w50">
                                    <input data-url="<?php echo base_url("galleries/galleryVideoIsActiveSetter/$item->id"); ?>" class="isActive" type="checkbox" data-switchery data-color="#10c469" <?php echo ($item->isActive) ? "checked" : ""; ?> />
                                </td>
                                <td class="text-center w200">
                                    <button data-url="<?php echo base_url("galleries/galleryVideoDelete/$item->id/$item->gallery_id"); ?>" class="btn btn-xs btn-danger btn-outline remove-btn">
